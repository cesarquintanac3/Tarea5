...
Presentado por Maria Margarita Ariza Acero () y Cesar Augusto Quintana Catano (201125995)
Fecha de creacion: 9 de octubre del 2013
"""
...
def cargar(archivoDeDatos):
    ...
    Output: Un arreglo donde en cada posicion se encuentran los datos de una fila del archivo que entro como parametro.
    """
